// GameCube "VaraNoir Academy: Roses" Japanese To English Translation

endian msb // GameCube PPC requires Big-Endian Encoding (Most Significant Bit)
output "../output/VaraNoir Academy Roses [E].iso", create
origin $000000; insert "../input/Gakuen Toshi Vara Noir Roses [J].iso" // Include Japanese VaraNoir ISO

//constant targetregion = 1;
